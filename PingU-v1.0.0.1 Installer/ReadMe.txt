...
2. Upon installation, a .bat file will be run automatically to create the log entry for PingU.
...
- Fixed bin path. Shortcut to .exe will be created in the folder upon installation.
